...
<div id="addtenant" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-lg">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full ">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add tenant admin2</h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-target="addtenant" data-modal-toggle="addtenant" id="close-modal-btn">
            ...
            <form action="{{ route('tenant.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter tenant name" required>
                    </div>
                    ...
                    <div>
                        <label for="start_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Masuk</label>
                    ...
                    <div>
                        <label for="end_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Keluar</label>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="file" name="ktp" id="ktp" accept="image/*" onchange="previewImage(event, 'preview-tenant')"  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 focus:outline-none" required>
                        
                        <div id="image-preview" class="mt-4">
                            <img id="preview-tenant" class="w-full max-h-60 rounded-lg object-cover" style="display: none;">
                        </div>
                    </div>
                </div>
 ...
 <script>
    ...
    const modal = document.getElementById('addtenant');
...
telInput.addEventListener('paste', (event) => {
    ...
    // ini function previewImage(event, previewId), bergunanya, previewimg(event) tidak apa sama, yang pentingnya data yang dimasukin previewIdnya, contoh input diatas manggil data preview-tenant di input fieldnya, lalu id img nya juga preview-tenant, jadi ditulis id yang mana harus dipaste fotonya
