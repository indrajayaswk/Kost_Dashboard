          ...
          <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
              <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                  ...
                  <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                      <button type="button" id="*" data-modal-target="adddashboard" data-modal-toggle="adddashboard" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                  ...
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      ...
                      <tbody>
                          <tr class="border-b dark:border-gray-700">
                              <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">I Putu Shri Indrajaya Shinga Warmadewa</th>
                              <td class="px-4 py-3">081239366793</td>
                              <td class="px-4 py-3">KTP.jpg</td>
                              <td class="px-4 py-3 max-w-[12rem] truncate">29-10-2002</td>
                              <td class="px-4 py-3">29-10-2011</td>
                          ...
                          <tr class="border-b dark:border-gray-700">
                              <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">Ni Kadek Vanilla Sutra</th>
                              <td class="px-4 py-3">0818343923</td>
                              <td class="px-4 py-3">KTP_whatsapp.jpg</td>
                              <td class="px-4 py-3 max-w-[12rem] truncate">6-11-2005</td>
                              <td class="px-4 py-3">6-11-2014</td>
                              <td class="px-4 py-3 flex items-center justify-end">
